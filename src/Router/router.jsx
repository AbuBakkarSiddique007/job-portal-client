...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://job-portal-server-drab-iota.vercel.app/jobs/${params.id}`)
            },
            {
                path: "/jobApply/:id",
            ...
            },
            {
                ...
                loader: ({ params }) =>
                    fetch(`https://job-portal-server-drab-iota.vercel.app/job-applications/jobs/${params.job_id}`)
            },
            {
                path: "/register",
